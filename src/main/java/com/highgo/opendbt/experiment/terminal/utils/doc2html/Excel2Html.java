...
import com.highgo.opendbt.experiment.terminal.utils.doc2html.bean.ExcelFontInfo;
import com.highgo.opendbt.experiment.terminal.utils.doc2html.bean.HtmlTable;
import com.highgo.opendbt.experiment.terminal.utils.doc2html.bean.HtmlTableTd;
import com.highgo.opendbt.experiment.terminal.utils.doc2html.bean.HtmlTableTr;
import com.highgo.opendbt.experiment.terminal.utils.doc2html.bean.dto.DocHtmlDto;
import com.highgo.opendbt.experiment.terminal.utils.doc2html.bean.dto.ExcelHtmlResultDto;
import com.highgo.opendbt.experiment.terminal.utils.doc2html.bean.dto.ExcelSheetDto;
...
public class Excel2Html implements Doc2Html {
  ...
  private static String getAlign(CellStyle cellStyle) {
	...
	static class FormartUtil {
		...
		static final SimpleDateFormat dateFmt1 = new SimpleDateFormat("yyyy��M��d��");
