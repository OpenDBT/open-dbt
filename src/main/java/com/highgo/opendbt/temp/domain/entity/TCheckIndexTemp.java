...
/**
 *
 * @TableName t_check_index_temp
 */
@TableName(value ="t_check_index_temp")
@Data
public class TCheckIndexTemp implements Serializable {
    /**
     * 主键
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        TCheckIndexTemp other = (TCheckIndexTemp) that;
