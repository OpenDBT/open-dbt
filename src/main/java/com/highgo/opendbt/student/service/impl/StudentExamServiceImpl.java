...
public class StudentExamServiceImpl implements StudentExamService {
  ...
  @Override
  public SubmitResult startVerifyAnswerThread(HttpServletRequest request, Score score, boolean isSaveSubmitData) throws ExecutionException, InterruptedException {
    Exam exam = examMapper.getExamById(score.getExamId());
    BusinessResponseEnum.EXAMINFOGETFILE.assertNotNull(exam);
    return progressService.startVerifyAnswerThread(request, score
