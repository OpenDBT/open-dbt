...
/**
 *
 * @TableName t_check_constraint
 */
@TableName(value ="t_check_constraint")
@Data
public class TCheckConstraint implements Serializable {
    /**
     * 主键
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        TCheckConstraint other = (TCheckConstraint) that;
