...
public class ProgressApi {
   ...
   * @return SubmitResult
   */
  @ApiOperation(value = "学生端练习提交答案")
  @PostMapping("/submitAnswer")
  public SubmitResult submitAnswer(HttpServletRequest request, @RequestBody @Valid Score score) throws ExecutionException, InterruptedException {
    logger.debug("Enter, score = " + score.toString());
    return progressService.startVerifyAnswerThread(request, score, 0, true, 0);
  }
}
